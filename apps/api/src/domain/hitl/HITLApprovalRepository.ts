...
export interface HITLApprovalRepository {
  findById(id: string, operatorId: string, organizationId: string): Promise<HITLApproval | null>;
  findPending(operatorId: string, organizationId: string): Promise<HITLApproval[]>;
