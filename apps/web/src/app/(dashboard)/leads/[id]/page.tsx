...
const MOCK_QUOTE_ITEMS = [
  {
    id: 1,
    description: "Next.js Frontend Setup",
    category: "Development",
    cost: 1500,
  },
  {
    id: 2,
    description: "Supabase Backend & DB",
    category: "Infrastructure",
    cost: 800,
  },
  {
    id: 3,
    description: "Agent Orchestration (CrewAI)",
    category: "AI Integration",
    cost: 2000,
  },
  {
    id: 4,
    description: "Vercel Deployment & CI/CD",
    category: "DevOps",
    cost: 500,
  },
];
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Client requested a complete CRM platform built with Next.js,
                integrating Supabase for auth and a custom AI agent layer to
                automate client onboarding and proposal generation.
              </p>
            </CardContent>
          </Card>
        </div>
                  ...
                  <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div className="flex gap-3 flex-row-reverse">
                      ...
                      <div className="bg-primary/10 text-foreground border border-primary/20 rounded-2xl rounded-tr-sm p-3 text-sm max-w-[80%]">
                        <p>
                          Hello! I can help you with that. Could you provide a
                          few more details about the specific AI features you
                          need? For example, do you need custom LLMs or standard
                          integrations?
                        </p>
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <div className="rounded-md border">
                        ...
                        <div className="divide-y">
                          {quoteItems.map((item) => (
                            <div
                              key={item.id}
                              className="grid grid-cols-12 text-sm p-3 items-center group"
                            >
                      ...
                      <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                        ...
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          ...
                          with AI integration, we estimated standard
                          frontend/backend setup alongside CrewAI orchestration
                          overhead. Infrastructure costs cover Vercel Pro and
                          Supabase Pro tiers for 1 year.
                        </p>
                      </div>
