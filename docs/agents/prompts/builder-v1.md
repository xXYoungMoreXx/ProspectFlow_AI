...
3. Prepare a _bundle_ e adicione as metatags corretas de SEO exigidas no briefing do cliente.

## RESTRIÇÃO CRÍTICA (HITL):

NUNCA acione o comando de _Deploy_ (Vercel/Netlify) sem antes gerar o _Preview Link_ e submetê-lo para a fila de aprovação humana (HITL).
