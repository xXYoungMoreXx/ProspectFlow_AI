...
└── adr/          → Architecture Decision Records (ADRs)
                    14 ADRs cobrindo Infraestrutura, Arquitetura, Segurança,
...
|--------|------|-------------|
| ✅ Aceito | ADR-003, 004, 005, 006, 010, 012, 013, 014 | Implementado no código atual |
...
### Infraestrutura
- [ADR-001](adr/ADR-001-runtime-orquestracao-agentes.md) — Runtime de orquestração *(Proposto: Claude Managed Agents — runtime atual: CrewAI)*
...
### Produto e Negócio
- [ADR-007](adr/ADR-007-modelo-negocio-precificacao.md) — Modelo de negócio e Pricing Engine *(Fase 10)*
- [ADR-008](adr/ADR-008-estrategia-entrega-sites.md) — Entrega de sites com templates curados *(Fase 13)*
...
### Legal / Compliance
- [ADR-011](adr/ADR-011-estrategia-contratual-compliance.md) — Clickwrap + LGPD + CDC *(Fase 12)*
...
*Última atualização: 2026-05-10 | Responsável: Arquiteto*
